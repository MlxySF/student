<?php
// Student Invoices & Payments Page - SECURED with CSRF protection
...
<?php if (!$filter_applied): ?>
    <div class="card"><div class="card-body text-center py-5">
        ...
        <div class="row justify-content-center"><div class="col-md-8"><div class="alert alert-info text-start">
...
<?php else: ?>
    <?php if (count($all_invoices) > 0): ?>
        <div class="row mb-4">
            <div class="col-md-4 mb-3"><div class="stat-card">
        ...
        <div class="card mb-4 border-danger">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive"><table class="table sp-invoices-table invoice-table-overdue">
                    ...
                    <tbody>
                        <?php foreach ($overdue_invoices as $inv): ?>
                            <tr class="sp-invoice-row table-danger">
                                <td><strong><?php echo e($inv['invoice_number']); ?></strong>
                                    ...
                                    <?php if ($inv['invoice_type'] === 'monthly_fee' && !empty($inv['payment_month'])): ?>
                                        <div class="d-md-none"><span class="badge bg-primary"><i class="fas fa-calendar"></i> <?php echo e($inv['payment_month']); ?></span></div>
                                    <?php endif; ?>
                                </td>
                                <td class="sp-hide-mobile"><?php echo date('d M Y', strtotime($inv['created_at'])); ?></td>
                                <td><?php echo e($inv['description']); ?>
                                    <?php if ($inv['invoice_type'] === 'monthly_fee' && !empty($inv['payment_month'])): ?>
                                        <br><span class="badge bg-primary mt-1"><i class="fas fa-calendar"></i> <?php echo e($inv['payment_month']); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="sp-hide-mobile"><?php echo $inv['class_code'] ? '<span class="badge bg-info">' . e($inv['class_code']) . '</span>' : '-'; ?></td>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive"><table class="table sp-invoices-table invoice-table-unpaid">
                    <thead><tr><th>Invoice #</th><th>Date</th><th>Description</th><th class="sp-hide-mobile">Class</th><th>Amount</th><th class="sp-hide-mobile">Due Date</th><th>Action</th></tr></thead>
                    <tbody>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive"><table class="table sp-invoices-table invoice-table-pending">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive"><table class="table sp-invoices-table invoice-table-paid">
      ...
      <?php elseif (in_array($inv['status'], ['unpaid', 'overdue'])): ?>
        <?php if (isClassFeeInvoice($inv)): ?>
          <div class="bank-details-card">
            ...
            <div class="bank-note"><i class="fas fa-info-circle"></i> <strong>Note:</strong> Please use this bank account for class fees, registration fees, and monthly payments only.</div>
          </div>
        <?php else: ?>
          <div class="bank-details-card equipment-bank">
            ...
            <div class="bank-note"><i class="fas fa-info-circle"></i> <strong>Note:</strong> Please use this bank account for equipment, uniforms, and clothing purchases only.</div>
          </div>
        <?php endif; ?>
