...
[The rest of the file content remains exactly the same until the footer buttons section]
    ...
    <div style="padding: 24px; background: white; border-top: 1px solid #e2e8f0; display: flex; justify-content: space-between; align-items: center;">
        <!-- ✨ UPDATED: Dynamic Back Button (Step 1 = Login Button, others = Normal) -->
        <a href="../index.php" id="back-to-login-btn" style="
            display: none;
            background: #1e293b;
            color: white;
            padding: 10px 24px;
            ...
            align-items: center;
            gap: 10px;
        " onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 6px 20px rgba(30, 41, 59, 0.4)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 12px rgba(30, 41, 59, 0.3)';">
            <i class="fas fa-arrow-left"></i>
            <span>Back to Login</span>
            <span style="color: #fbbf24; font-size: 12px;">返回登录</span>
        </a>
        
        <button id="btn-prev" onclick="changeStep(-1)" style="
            padding: 10px 24px; 
            border-radius: 12px; 
            font-weight: 600; 
            color: #64748b; 
        ...
        <button id="btn-next" onclick="changeStep(1)" style="
            background: #1e293b; 
            color: white; 
            padding: 10px 32px; 
            border-radius: 12px; 
