...
// Public Student Registration Form - FIXED VERSION
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input[type="radio"][name="status"] { display: none; }
        .status-option { transition: all 0.2s ease; cursor: pointer; }
        .custom-checkbox {
            display: flex;
        ...
        .custom-checkbox input[type="checkbox"]:hover { border-color: #fbbf24; }
        ...
        .custom-checkbox-label { flex: 1; line-height: 1.5; }
        .school-box {
        ...
        .school-header:hover { background: #f1f5f9; }
        .school-info { display: flex; align-items: center; gap: 16px; flex: 1; }
        .school-logo {
            width: 50px;
            height: 50px;
            border-radius: 50%;
        ...
        .school-text p { font-size: 13px; color: #64748b; margin: 0; }
        .school-toggle {
            width: 32px;
            height: 32px;
            border-radius: 50%;
        ...
        .school-toggle i { transition: transform 0.3s; color: #475569; }
        .school-box.active .school-toggle { background: #fbbf24; }
        .school-box.active .school-toggle i { transform: rotate(180deg); color: white; }
        .school-schedules { max-height: 0; overflow: hidden; transition: max-height 0.3s ease; }
        .school-schedules-inner { padding: 0 20px 20px 20px; }
        .school-box.active .school-schedules { max-height: 1000px; }
...
<!-- Due to character limits, I'll create this as separate files. Let me push the process_registration.php fix first -->