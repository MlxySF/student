    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="payment-box">
                ...
                <p style="margin: 10px 0; color: #64748b;">Login to your dashboard to pay this invoice online.</p>
                <a href="' . $portalUrl . '" class="payment-btn" style="color: white;">Go to Invoices Page</a><br>
            </div>
        ...
        <div class="footer">
            ...
            <p style="margin: 4px 0;">Wushu Sport Academy System</p>
